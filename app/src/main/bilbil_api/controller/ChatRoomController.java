...
public class ChatRoomController {
    ...
    public ResponseEntity<MsgEntity> markMessagesRead(
            @PathVariable Integer roomId,
            @AuthenticationPrincipal Integer currentUserId
    ) {
        if (currentUserId == null) {
        ...
        List<ChatMessage> unreadMessages =
                chatService.getUnreadMessages(roomId, currentUserId);
        ...
        for (ChatMessage msg : unreadMessages) {
            ...
            readEvent.put("messageId", msg.getId());
            readEvent.put("readerId", currentUserId);
